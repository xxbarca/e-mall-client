  ...
  return <form className={'flex flex-col gap-4'} onSubmit={handleSubmit(handleShippingForm)}>
    <div className={'flex flex-col gap-1'}>
      ...
      <input
        ...
        type={'text'}
        id={'name'}
        placeholder={'please input name'} {...register("name")}
      />
    ...
    <div className={'flex flex-col gap-1'}>
      ...
      <input
        ...
        type={'text'}
        id={'email'}
        placeholder={'please input email'} {...register("email")}
      />
    ...
    <div className={'flex flex-col gap-1'}>
      ...
      <input
        ...
        type={'text'}
        id={'phone'}
        placeholder={'please input phone'} {...register("phone")}
      />
    ...
    <div className={'flex flex-col gap-1'}>
      ...
      <input
        ...
        type={'text'}
        id={'address'}
        placeholder={'please input address'} {...register("address")}
      />
    ...
    <div className={'flex flex-col gap-1'}>
      ...
      <input
        ...
        type={'text'}
        id={'city'}
        placeholder={'please input city'} {...register("city")}
      />
